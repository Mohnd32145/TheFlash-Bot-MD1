	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363334163906836@newsletter',
            newsletterName: '𝑻𝑬𝑹𝑩𝑶〔⚡️〕𝑩𝑶𝑻', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
global.canalIdGB = ["120363323738773490@newsletter"]
global.canalNombreGB = ["𝑻𝑼𝑹𝑩𝑶", "𝑻𝑼𝑹𝑩𝑶﹝⚡️﹞𝑩𝑶𝑻", "𝑻𝑼𝑹𝑩𝑶", "𝑻𝑼𝑹𝑩𝑶﹝⚡️﹞𝑩𝑶𝑻"]
